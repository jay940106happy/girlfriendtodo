...
function drawMap() {
  ...
  for (const item of locations.value) {
    ...
    const icon = window.L.divIcon({
      ...
      html: `<button class="photo-map-marker" aria-label="${label}"><img src="${imageUrl}" alt="" /></button>`,
      iconSize: [54, 62],
      iconAnchor: [27, 58]
    })
